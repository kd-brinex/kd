...
//                'auto/map/<modelid:\w+>/<treeid:\w+>' => 'auto/auto/map',
                ...
                '/autocatalogs/<marka:\w+>/<family:[\w\s-]+>/<cat_code:\w+>/<cat_folder:\w+>/<sect:\w+>' => '/autocatalog/autocatalog/subcatalog',
                '/autocatalogs/<marka:\w+>/<family:[\w\s-]+>/<cat_code:\w+>/<cat_folder:\w+>/<sect:\w+>/<sub_sect:\w+>' => '/autocatalog/autocatalog/parts',
